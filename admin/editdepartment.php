...
$query->execute();
$msg="Departamento actualizado exitósamente";
}
...
<html lang="es">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Actualizar Departamento</title>
  ...
  <?php include('includes/header.php');?>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Actualizar Departamento</div>
                    </div>
...
<input id="departmentshortname" type="text"  class="validate" autocomplete="off" value="<?php echo htmlentities($result->DepartmentShortName);?>" name="departmentshortname"  required>
                                                <label for="deptshortname">Nombre Corto de Departamento</label>
                                            </div>
  <div class="input-field col s12">
 <input id="deptcode" type="text" name="deptcode" class="validate" autocomplete="off" value="<?php echo htmlentities($result->DepartmentCode);?>" required>
                                                <label for="password">Código de Departamento</label>
                                            </div>
