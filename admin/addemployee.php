...
if($lastInsertId)
{
$msg="Registro de Empleado Agregado Exitósamente";
}
else 
{
...
<div class="input-field col s12">
<button type="submit" name="add" onclick="return valid();" id="add" class="waves-effect waves-light btn indigo m-b-xs">Agregar</button>
