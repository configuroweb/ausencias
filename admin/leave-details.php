...
{         
  ...
  <tr>
                                            ...
                                            <td>Desde <?php echo htmlentities($result->FromDate);?> Hasta <?php echo htmlentities($result->ToDate);?></td>
    ...
    <div class="modal-content" style="width:90%">
        <h4>Tomar acción</h4>
          <select class="browser-default" name="status" required="">
                                        ...
                                        <p><textarea id="textarea1" name="description" class="materialize-textarea" name="description" placeholder="Descripción" length="500" maxlength="500" required></textarea></p>
    </div>
