...
<html lang="es">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Historial de Ausencias Pendientes</title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Historial de Ausencias Pendientes</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Historial Ausencias</span>
