...
<html lang="es">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Solicitudes de Ausencia no Aprobadas</title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"> Historial de Ausencias no Aprobadas</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Listado Ausencias no Aprobadas</span>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="120">Tipo de Ausencia</th>
                                             ...
                                             <th width="180">Fecha Solicitud</th>                 
                                            <th>Status</th>
