...
if($stats){
 ...
 {?>
<a href="manageemployee.php?inid=<?php echo htmlentities($result->id);?>" onclick="return confirm('¿Estás seguro de que quieres inactivar este Empleado?');"" > <i class="material-icons" title="Inactive">clear</i>
<?php } else {?>

                                            <a href="manageemployee.php?id=<?php echo htmlentities($result->id);?>" onclick="return confirm('¿Está seguro de que desea activar a este empleado?');""><i class="material-icons" title="Active">done</i>
                                            <?php } ?> </td>
                                        </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
