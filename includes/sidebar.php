...
{               ?>
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="emp-changepassword.php"><i class="material-icons">settings_input_svideo</i>Cambiar Contraseña</a></li>
                    <li class="no-padding">
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="apply-leave.php">Solicitar Ausencia</a></li>
                                <li><a href="leavehistory.php">Historial Ausencias</a></li>
                            </ul>
                        </div>
                    </li>
